...
{
    public class ScriptCharacter : AbstractScriptCharacter
    {
        ...
        public override short SubJob => Character.SubJob;
        ...
        public override int[] SpTable => Character.SpTable;
        ...
        public override void GainMesos(long amount, bool showInChat = true, bool fromMonster = false) => Character.Inventory.GainMesos(amount, fromMonster, showInChat);
        public override void RemoveMesos(long amount, bool showInChat = true, bool fromMonster = false) => Character.Inventory.RemoveMesos(amount, fromMonster, showInChat);
