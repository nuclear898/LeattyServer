...
namespace LeattyServer.Constants
{
    ...
    public static class JobConstants
    {
        ...
        public const int ARANBASICS = 2000;
        public const int ARAN1 = 2100;
        ...
        public const int LUMINOUSBASICS = 2004;
        public const int LUMINOUS1 = 2700;
        public const int LUMINOUS2 = 2710;
        public const int LUMINOUS3 = 2711;
        public const int LUMINOUS4 = 2712;
        ...
        {
            return  job == JobConstants.EXPLORER || 
                    job == JobConstants.CYGNUS ||
                    job == JobConstants.ARANBASICS || job == JobConstants.EVANBASICS || job == JobConstants.MERCEDESBASICS || job == JobConstants.PHANTOMBASICS || job == JobConstants.LUMINOUSBASICS ||
                    job == JobConstants.RESISTANCE || job == JobConstants.DEMONBASICS || job == JobConstants.XENONBASICS ||
                    job == JobConstants.HAYATOBASICS || job == JobConstants.KANNABASICS ||
                    job == JobConstants.MIHILEBASICS ||
                    job == JobConstants.KAISERBASICS || job == JobConstants.ANGELICBUSTERBASICS ||
                    job == JobConstants.ZEROBASICS ||
                    (job >= 7000 && job < 10000);
        }
