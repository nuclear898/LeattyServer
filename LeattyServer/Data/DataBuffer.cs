...
namespace LeattyServer.Data
{
    class DataBuffer
    {
        ...
        public static List<CashShop.DbItem> CSItems = new List<CashShop.DbItem>();   
        ...
        public static List<Pair<int, string>> GetItemsByName(string name)
        {
            name = name.ToLower();
            List<Pair<int, string>> idNamePairs = new List<Pair<int, string>>();
            foreach (var kvp in EquipBuffer.Where(x => x.Value.Name != null && x.Value.Name.ToLower().Contains(name)))
            {
                idNamePairs.Add(new Pair<int, string>(kvp.Key, kvp.Value.Name));
            }
        ...
        public static List<Pair<int, string>> GetMobsByName(string name)
        {
            name = name.ToLower();
            var idNamePairs = new List<Pair<int, string>>();
        ...
        public static List<Pair<int, string>> GetMapsByName(string name)
        {
            name = name.ToLower();
            List<Pair<int, string>> idNamePairs = new List<Pair<int, string>>();
