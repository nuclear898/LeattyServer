...
namespace LeattyServer.Crypto
{
    ...
    public class CipherHelper
    {
        ...
        public CipherHelper(UInt16 currentGameVersion, UInt16 initialBufferSize = 0x100)
        {            
            RecvCipher = new Cipher(currentGameVersion, ServerConstants.CWvsKey);
            SendCipher = new Cipher(currentGameVersion, ServerConstants.CWvsKey);
