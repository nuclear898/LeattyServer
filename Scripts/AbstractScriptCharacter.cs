...
namespace LeattyServer.Scripting
{
    ...
    public abstract class AbstractScriptCharacter
    {
        ...
        public abstract short SubJob { get; }
        ...
        public abstract int[] SpTable { get; }
        ...
        public abstract void GainMesos(long gain, bool showInChat = true, bool fromMonster = false);
        public abstract void RemoveMesos(long loss, bool showInChat = true, bool fromMonster = false);
        ...
        public bool IsThief => Job / 100 == 4 && SubJob == 0;
        public bool IsAssassin => Job / 10 == 41;
        public bool IsBandit => Job / 10 == 42;
        public bool IsDualBlade => SubJob == 1;
        public bool IsPirate => Job / 100 == 5 && SubJob == 0;
        public bool IsBrawler => Job / 10 == 51;
        public bool IsGunslinger => Job / 10 == 52;
        public bool IsCannonneer => SubJob == 2;
