...
namespace LeattyServer.ServerInfo.Player
{
    public class MapleTrade
    {
        ...
        {
            public readonly MapleItem Item;
        ...
        // public static Dictionary<int, MapleTrade> Trades = new Dictionary<int, MapleTrade>();//ID of owner | Trade
        ...
        public long OwnerMesos { get; set; }
        public long PartnerMesos { get; set; }
        ...
        public void AcceptTrade(MapleCharacter chr)
        {
            ...
            {
                ServerConsole.Error("Unable to accept trade because this character isn't registered as in the trade. Partner count " + Partners.Count);
                return;
            }
            if (OwnerAccepted && PartnerAccepted)
            {
                ...
                if (OwnerMesos + partner.Inventory.Mesos <= GameConstants.MAX_MESOS && PartnerMesos + owner.Inventory.Mesos <= GameConstants.MAX_MESOS &&
