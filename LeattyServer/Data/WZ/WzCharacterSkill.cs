...
namespace LeattyServer.Data.WZ
{
    ...
    public class SkillEffect
    {
        ...
        {  
            ...
            {                    
                ...
                ServerConsole.Error("Skill " + Parent.SkillId + " is a Party ability but has no bounding box or range attributes");            
        ...
        public void LoadBuffStats()
        {
            ...
            //CheckAndAddBuffStat(MapleBuffStat.ENHANCED_MAXHP, CharacterSkillStat.emhp);
            //CheckAndAddBuffStat(MapleBuffStat.ENHANCED_MAXMP, CharacterSkillStat.emmp);
            //CheckAndAddBuffStat(MapleBuffStat.ENHANCED_WATK, CharacterSkillStat.epad);
            //CheckAndAddBuffStat(MapleBuffStat.ENHANCED_MATK, CharacterSkillStat.emad);
            //CheckAndAddBuffStat(MapleBuffStat.ENHANCED_WDEF, CharacterSkillStat.epdd);
            //CheckAndAddBuffStat(MapleBuffStat.ENHANCED_MDEF, CharacterSkillStat.emdd);
            //CheckAndAddBuffStat(MapleBuffStat.STR, CharacterSkillStat.str);
            //CheckAndAddBuffStat(MapleBuffStat.DEX, CharacterSkillStat.dex);
            //CheckAndAddBuffStat(MapleBuffStat.INT, CharacterSkillStat.int_);
            //CheckAndAddBuffStat(MapleBuffStat.LUK, CharacterSkillStat.luk);
            //CheckAndAddBuffStat(MapleBuffStat.STACKING_WATK, CharacterSkillStat.indiePad);
            //CheckAndAddBuffStat(MapleBuffStat.STACKING_MATK, CharacterSkillStat.indieMad);
            ...
            {                   
                ...
                case Aran1.COMBO_ABILITY:                    
                    //BuffInfo.Add(MapleBuffStat.COMBO_ABILITY, 1);
                    break;
                case LuminousBasics.SUNFIRE:
                case LuminousBasics.ECLIPSE:
                    //BuffInfo.Add(MapleBuffStat.ECLIPSE_SUNFIRE, 1);
                    break;
                case Luminous2.BLACK_BLESSING:
                    //BuffInfo.Add(MapleBuffStat.BLACK_BLESSING, 1);
                    Info[CharacterSkillStat.time] = MAX_BUFF_TIME_S;
                    break;
        ...
        public static class Packets
        {
            ...
            {
                PacketWriter pw = new PacketWriter(SendHeader.ShowForeignSkillEffect);
    ...
    public enum CharacterSkillStat : int
    {
        ...
        aranComboCon, //Aran combo consumed
